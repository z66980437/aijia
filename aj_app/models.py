...
class House(BaseModel, db.Model):
    ...
    # 房屋容纳的人数
    capacity = db.Column(db.String(64), default=1)
    # 房屋床铺配置
    beds = db.Column(db.String(64), default=1)
    # 房屋押金
    ...
    # 房屋主图片
    index_image_url = db.Column(db.String(512), default='')
    landlord_url = ''
    # 房屋的设施
    ...
    def to_dict(self):
        return {
            ...
            'landlord_url': self.landlord_url if self.landlord_url else '',
        }
